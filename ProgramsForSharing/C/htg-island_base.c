...
#define NBINOM 4 // Binomial parameter such that n p +2 = m (other combination is n=5, p=0.8)
#define PBINOM 0.5 // Binomial parameter such that n p + 2 = m
#define NDEMES 15   // Number of demes
...
void GenerateDemeSizes(void)
{
  if(HTG == 1){
    ...
    for(ideme = 0; ideme<NDEMES; ideme++){
      ...
      // Put at least two individuals in each deme
      demesize[ideme] = 2;
