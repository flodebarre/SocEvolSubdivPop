...
Hamilton 1964 viscous (low dispersal) ``giving-traits'' more common in viscous population. Notion that tighter links between individuals favors the evolution of altruism has been shown to hold (othsuki et autres). The rationale behind this is that altruism is favored when altruists interact more with altruists than defectors do; the more viscous the population, the more likely it is that.
