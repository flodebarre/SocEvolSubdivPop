...
For each life-cycle, we will further decompose the $-\mathcal{C}$ and $\mathcal{B}$ terms into primary and secondary effects TODO CITE Gardner . Primary effects correspond to unmediated, direct consequences of interactions (they are included in $\derivn{W}{f_{\focal}}$), while secondary effects correspond to consequences of interactions mediated by other individuals, competition. 
...
(1-\mu) \bb \\
- (\bb - \cc) (n-1) \left( \frac{(1-m)^2}{n} + \frac{m^2}{N-n} \right) 
\end{pmatrix}
