...
\paragraph{Short Running Title:} Mutation and altruism in subdivided populations ($47$~characters).
...
\todo[inline]{Titre!!!}
\todo[inline]{Abstract!!!}
\todo[inline]{Fin discussion qui est encore en notes}
\todo[inline]{Voter model, faire figure et discuter de la deconnexion entre d et e}
...
Westetal2002 for review on competition. 
Indirect effects and cancellation result Taylor1992 + \citep{Queller1994} \citep[][with $n$ player games]{Ohtsuki2010}
Indirect effects scale of competition explain why BD DB differences \citep{GrafenArchetti2008}. Can explain the evolution of social behaviors such as spite \citep{WestGardner2010}WG10. Mitigate the effects of fecundity costs associated to a beneficial trait \citep{Debarre2015evo}.
