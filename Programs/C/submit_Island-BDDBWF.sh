...
echo -e "#!/bin/bash\n./${THEPATH}Scripts/iscr${updating}_${mig}_${mB}_${mp}_${mutt}_${omega} > ${THEPATH}Results/s1${updating}_${mig}_${mB}_${mp}_${mutt}.txt" > Scripts/is${updating}_${mig}_${mB}_${mp}_${mutt}_${omega}.sh
