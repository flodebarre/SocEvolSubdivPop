...
\node[text width=0.8\textwidth, font=\Large, align=center, color=maincol]at(0,0)(tit){ Social evolution in structured populations};
...
\node[below = 0.75cm of FD, align=center, font =\footnotesize](affil){ CNRS, Paris};

\node[opacity=0.7, below = 0.5cm of affil]{\includegraphics[width = 6cm]{../Pics/affichePloen.pdf}};
%%TODO Ajouter affiche Ploen
...
\node[right = 0cm of anrn.south east, align = center, anchor = south west](Ch){Laura Hindersin \& Stefano Giaimo  \\ {\small for organizing the workshop}};

\node[right = 0cm of Ch, color = maincol, text width = 4cm, font = \large, align = center]{and thank you for your attention!};
