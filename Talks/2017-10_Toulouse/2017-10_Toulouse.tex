...
\item<+-> In subdivided populations, $\mathbb{E}[\overline{X}]$ can increase with the emigration probability $m$ when strategy transmission is imperfect ($\mu > 0$).  \hspace{\stretch{1}}{\footnotesize \textcolor{mgray}{D., (\textit{in prep.})}}
