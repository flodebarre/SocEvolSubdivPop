...
\definecolor{maincol}{HTML}{F37D31}%{RGB}{0, 107, 137} % Bleu canard %006b8b
...
\definecolor{col4}{HTML}{2C5AA0}%{6C0013} % Opposite of light green
...
\newcommand{\citeref}[1]{\textcolor{mgray}{#1}}